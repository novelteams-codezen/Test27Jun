...
namespace Test27Jun.Controllers
{
    ...
    /// </remarks>
    [Route("api/productformulation")]
    [Authorize]
    public class ProductFormulationController : ControllerBase
    {
        ...
        [UserAuthorize("ProductFormulation",Entitlements.Create)]
        ...
        [HttpGet]
        [UserAuthorize("ProductFormulation",Entitlements.Read)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        /// <returns>The result of the operation</returns>
        [HttpDelete]
        [UserAuthorize("ProductFormulation",Entitlements.Delete)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        ...
        /// <returns>The result of the operation</returns>
        [HttpPut]
        [UserAuthorize("ProductFormulation",Entitlements.Update)]
        [Route("{id:Guid}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status401Unauthorized)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
