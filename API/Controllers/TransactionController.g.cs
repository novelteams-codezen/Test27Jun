...
{
    /// <summary>
    /// Controller responsible for managing transaction related operations.
    /// </summary>
    /// <remarks>
    ...
    public class TransactionController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TransactionController class with the specified context.
        /// </summary>
        /// <param name="itransactionservice">The itransactionservice to be used by the controller.</param>
        ...
        {
            var id = _transactionService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _transactionService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _transactionService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Transaction updatedEntity)
        {
            ...
            var status = _transactionService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Transaction> updatedEntity)
        {
            ...
            var status = _transactionService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}