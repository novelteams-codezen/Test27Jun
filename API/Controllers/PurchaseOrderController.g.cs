...
namespace Test27Jun.Controllers
{
    ...
    public class PurchaseOrderController : ControllerBase
    {
        ...
        {
            var id = _purchaseOrderService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _purchaseOrderService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _purchaseOrderService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] PurchaseOrder updatedEntity)
        {
            ...
            var status = _purchaseOrderService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<PurchaseOrder> updatedEntity)
        {
            ...
            var status = _purchaseOrderService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}