...
namespace Test27Jun.Controllers
{
    ...
    public class ProductCategoryController : ControllerBase
    {
        ...
        {
            var id = _productCategoryService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _productCategoryService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] ProductCategory updatedEntity)
        {
            ...
            var status = _productCategoryService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<ProductCategory> updatedEntity)
        {
            ...
            var status = _productCategoryService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}