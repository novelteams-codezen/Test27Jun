...
namespace Test27Jun.Controllers
{
    ...
    public class StockAdjustmentController : ControllerBase
    {
        ...
        {
            var id = _stockAdjustmentService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _stockAdjustmentService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var result = _stockAdjustmentService.GetById(id);
            return Ok(result);
        }
        ...
        {
            var status = _stockAdjustmentService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] StockAdjustment updatedEntity)
        {
            ...
            var status = _stockAdjustmentService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<StockAdjustment> updatedEntity)
        {
            ...
            var status = _stockAdjustmentService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}