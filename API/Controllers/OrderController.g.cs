...
namespace Test27Jun.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the OrderController class with the specified context.
        /// </summary>
        /// <param name="iorderservice">The iorderservice to be used by the controller.</param>
        ...
        {
            var id = _orderService.Create(model);
            return Ok(new { id });
        }
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var result = _orderService.Get(filterCriteria, searchTerm, pageNumber, pageSize, sortField, sortOrder);
            return Ok(result);
        }
        ...
        {
            var status = _orderService.Delete(id);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] Order updatedEntity)
        {
            ...
            var status = _orderService.Update(id, updatedEntity);
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<Order> updatedEntity)
        {
            ...
            var status = _orderService.Patch(id, updatedEntity);
            return Ok(new { status });
        }
    }
}