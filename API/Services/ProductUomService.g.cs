...
namespace Test27Jun.Services
{
    ...
    public class ProductUomService : IProductUomService
    {
        ...
        public ProductUomService(Test27JunContext dbContext)
        {
        ...
        {
            var entityData = _dbContext.ProductUom.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
            return entityData;
        }
        ...
        private List<ProductUom> GetProductUom(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _dbContext.ProductUom.IncludeRelated().AsQueryable();
