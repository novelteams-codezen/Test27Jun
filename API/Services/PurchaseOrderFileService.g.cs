...
namespace Test27Jun.Services
{
    ...
    public class PurchaseOrderFileService : IPurchaseOrderFileService
    {
        ...
        public PurchaseOrderFileService(Test27JunContext dbContext)
        {
        ...
        {
            var entityData = _dbContext.PurchaseOrderFile.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
            return entityData;
        }
        ...
        private List<PurchaseOrderFile> GetPurchaseOrderFile(List<FilterCriteria> filters = null, string searchTerm = "", int pageNumber = 1, int pageSize = 1, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _dbContext.PurchaseOrderFile.IncludeRelated().AsQueryable();
